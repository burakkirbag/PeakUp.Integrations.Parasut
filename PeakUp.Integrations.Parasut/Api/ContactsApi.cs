...
namespace PeakUp.Integrations.Parasut.Api
{
    ...
    public interface IContactsApi : IApiAccessor
    {
        ...
        /// <param name="filterArchived"> (optional)</param>
        ...
        InlineResponse2002 ListContacts(int? companyId, string filterName = null, string filterEmail = null, string filterTaxNumber = null, string filterTaxOffice = null, string filterCity = null, string filterAccountType = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        ...
        ApiResponse<InlineResponse2002> ListContactsWithHttpInfo(int? companyId, string filterName = null, string filterEmail = null, string filterTaxNumber = null, string filterTaxOffice = null, string filterCity = null, string filterAccountType = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null);
        /// <summary>
        /// Ödeme
        /// </summary>
        /// <remarks>
    ...
    public partial class ContactsApi : IContactsApi
    {
        ...
        /// <param name="include">Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, contact_portal, contact_people* (optional)</param>
        /// <returns>InlineResponse2002</returns>
        public InlineResponse2002 ListContacts(int? companyId, string filterName = null, string filterEmail = null, string filterTaxNumber = null, string filterTaxOffice = null, string filterCity = null, string filterAccountType = null, bool? filterArchived = null, string sort = null, int? pageNumber = null, int? pageSize = null, string include = null)
        {
            ApiResponse<InlineResponse2002> localVarResponse = ListContactsWithHttpInfo(companyId, filterName, filterEmail, filterTaxNumber, filterTaxOffice, filterCity, filterAccountType, filterArchived, sort, pageNumber, pageSize, include);
            return localVarResponse.Data;
        }
        ...
        {
            ApiResponse<InlineResponse2002> localVarResponse = await ListContactsAsyncWithHttpInfo(companyId, filterName, filterEmail, filterTaxNumber, filterTaxOffice, filterCity, filterAccountType, filterArchived, sort, pageNumber, pageSize, include);
            return localVarResponse.Data;
